    ...
    <view class="main-header" :style="{ paddingTop: $platform == 'H5' ? '0' : '50rpx' }">
      ...
      <view v-if="isLogin" class="user-info">
		...
		<view class="amount-info">
			<view class="amount-tip">收款额（元）</view>
			<view class="amount-num">{{ dataInfo.payMoney.toFixed(2) }}</view>
		</view>
      </view>
      <!-- 未登录 -->
...
<script>
  ...
  const orderNavbar = [
    ...
    { id: 'payment', name: '售后', icon: 'daifukuan', count: 0 },
    { id: 'completed', name: '消息', icon: 'daishouhuo', count: 1 },
  ]
  ...
  const service = [
    ...
    { id: 'coupon', name: '营销活动', icon: 'lingquan', type: 'link', url: 'pages/give/index' },
	{ id: 'points', name: '订单管理', icon: 'dingdan', type: 'link', url: 'pages/points/detail' },
    { id: 'help', name: '会员管理', icon: 'tuandui', type: 'link', url: 'pages/help/index' },
    { id: 'contact', name: '在线客服', icon: 'kefu', type: 'button', openType: 'contact' },
	{ id: 'address', name: '报表数据', icon: 'zhibozhong', type: 'link', url: 'pages/address/index' },
	...
	{ id: 'merchant', name: '核销员', icon: 'sy-yh', type: 'link', url: 'pages/merchant/index' },
  ]
